...
export interface AttendanceFindByStudentIdRequestParams {
    studentId: string;
    page?: number;
    limit?: number;
}
...
export class AttendanceService extends BaseService {
     ...
     * @param options additional options
     */
    public attendanceFindByStudentId(requestParameters: AttendanceFindByStudentIdRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<AttendanceFindAllDefaultResponse>;
    public attendanceFindByStudentId(requestParameters: AttendanceFindByStudentIdRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<AttendanceFindAllDefaultResponse>>;
    public attendanceFindByStudentId(requestParameters: AttendanceFindByStudentIdRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<AttendanceFindAllDefaultResponse>>;
    public attendanceFindByStudentId(requestParameters: AttendanceFindByStudentIdRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const studentId = requestParameters?.studentId;
        if (studentId === null || studentId === undefined) {
            throw new Error('Required parameter studentId was null or undefined when calling attendanceFindByStudentId.');
        }
        const page = requestParameters?.page;
        const limit = requestParameters?.limit;
        ...
        let localVarPath = `/api/attendances/student/${this.configuration.encodeParam({name: "studentId", value: studentId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<AttendanceFindAllDefaultResponse>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    public attendanceUpdate(requestParameters: AttendanceUpdateRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const updateAttendanceDto = requestParameters?.updateAttendanceDto;
